import svgPaths from "./svg-c8yw6wjg7k";
import { imgGroup, imgGroup1 } from "./svg-pl81z";
        ...
        <div className="box-border content-stretch flex flex-row gap-2.5 items-center justify-center pl-[5px] pr-0 py-0 relative w-full">
          <div className="basis-0 flex flex-col font-['Pretendard:Regular',_sans-serif] grow justify-center leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#000000] text-[16px] text-left">
            <p className="block leading-[normal]">
              ...
              써보고 흙으로 덮어 버리었읍니다. 나는 무엇인지 그리워 이 많은
              별빛이 내린 언덕 위에 내 이름자를 써보고 흙으로 덮어
              버리었읍니다.나는 무엇인지 그리워 이 많은 별빛이 내린 언덕 위에 내
              이름자를 써보고 흙으로 덮어 버리었읍니다.나는 무엇인지 그리워 이
    ...
    <div className="relative shrink-0 w-full">
      ...
      <div className="flex flex-row items-center relative size-full">
        <div className="box-border content-stretch flex flex-row items-center justify-between px-[25px] py-[15px] relative w-full">
          <Frame121 />
          <div
            className="h-[11.656px] relative shrink-0 w-[17.75px]"
            data-name="Vector"
          >
            <svg
              className="block size-full"
...
export default function Faqs() {
  return (
    <div className="bg-[#ffffff] relative size-full" data-name="faqs">
      <Header />
      <Footer />
      <Frame144 />
    </div>

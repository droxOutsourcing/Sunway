...
import { imgRectangle3 } from "@/assets/images/placeholder";
...
function Frame114() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-row gap-[30px] items-start justify-center left-1/2 p-0 translate-x-[-50%] translate-y-[-50%] w-[1100px]"
      style={{ top: "calc(50% - 747px)" }}
    >
      <Frame115 />
      <div
...
function Footer() {
  return (
    ...
    >
      <Frame137 />
      <div className="flex flex-col font-['Pretendard:Regular',_'Noto_Sans_Symbols:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[12px] text-left text-nowrap">
...
function Frame11() {
  return (
    <div className="basis-0 bg-[#136bd0] grow min-h-px min-w-px relative rounded-tr-[10px] shrink-0">
      <div className="flex flex-row items-center justify-center overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-row gap-2.5 items-center justify-center px-[45px] py-[13px] relative w-full">
          <div className="font-['Inter:Semi_Bold',_'Noto_Sans_KR:Bold',_sans-serif] font-semibold leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[21px] text-left text-nowrap">
...
function Frame12() {
  return (
    <div className="basis-0 bg-[#ffffff] grow min-h-px min-w-px relative rounded-tr-[10px] shrink-0">
      <div className="flex flex-row items-center justify-center overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-row gap-2.5 items-center justify-center px-[45px] py-[13px] relative w-full">
          <div className="font-['Inter:Medium',_'Noto_Sans_KR:Regular',_sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#000000] text-[21px] text-left text-nowrap">
...
function Tabs() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col items-start justify-start left-[100px] p-0 shadow-[0px_5px_15px_0px_rgba(0,0,0,0.05)] top-[493px] w-[1100px]"
      data-name="tabs"
    >
      <Frame18 />
      <Frame148 />
...
export default function About() {
  return (
    <div className="bg-[#ffffff] relative size-full" data-name="about">
      <Header />
      <Frame114 />
      <Footer />
      <Tabs />

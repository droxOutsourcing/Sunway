import svgPaths from "./svg-psqffacfxq";
import { imgRectangle13 } from "@/assets/images/placeholder";
import { imgGroup, imgGroup1 } from "./svg-h98b3";
...
function Frame35() {
  return (
    <div className="box-border content-stretch flex flex-col gap-2.5 items-start justify-start p-0 relative shrink-0 w-full">
      ...
      <div className="h-[52px] relative rounded-[999px] shrink-0 w-full">
        <div className="absolute border border-[#000000] border-solid inset-0 pointer-events-none rounded-[999px]" />
      </div>
    </div>
  );
}
...
function Frame38() {
  return (
    <div className="box-border content-stretch flex flex-col gap-2.5 items-start justify-start p-0 relative shrink-0 w-full">
      ...
      <div className="h-[186px] relative rounded-[25px] shrink-0 w-full">
        <div className="absolute border border-[#000000] border-solid inset-0 pointer-events-none rounded-[25px]" />
      </div>
    </div>
  );
}
...
function Frame39() {
  return (
    <div className="bg-[#121212] box-border content-stretch flex flex-row gap-2.5 items-center justify-center px-[25px] py-[15px] relative rounded-[15px] shrink-0">
...
function Frame40() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[25px] items-start justify-start px-10 py-[35px] relative rounded-[30px] shrink-0 w-[577px]">
...
function Frame151() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[30px] items-start justify-start left-[100px] p-0 top-[93px] w-[1100px]">
      <PageHeader />
      <Frame155 />
      <Frame42 />
      <Frame68 />
...
export default function Contact() {
  return (
    <div className="bg-[#ffffff] relative size-full" data-name="contact">
      <Header />
      <Footer />
      <Frame151 />
    </div>

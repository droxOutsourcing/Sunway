import svgPaths from "./svg-rta2n54yt6";
import { imgFrame1021 } from "@/assets/images/placeholder";
import { imgGroup, imgGroup1 } from "./svg-m97yk";
...
function PageHeader() {
  return (
    <div
      className="bg-[#1b1b1b] box-border content-stretch flex flex-row h-[120px] items-center justify-between leading-[0] not-italic px-[60px] py-[38px] relative rounded-[20px] shrink-0 text-[#ffffff] text-left text-nowrap w-[1100px]"
...
function Frame117() {
  return (
    <div className="box-border content-stretch flex flex-row gap-2.5 items-center justify-center pl-[5px] pr-0 py-0 relative shrink-0">
      <div className="flex flex-col font-['Pretendard:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#000000] text-[16px] text-left text-nowrap">
        <p className="block leading-[normal] whitespace-pre">
...
function Frame116() {
  return (
    <div className="bg-[#f1f1f1] relative rounded-[5px] shrink-0 w-full">
...
function Frame1067() {
  return (
    <div className="bg-[#136bd0] box-border content-stretch flex flex-col gap-2.5 items-center justify-center overflow-clip px-[7px] py-[3px] relative rounded-[3px] shrink-0 size-[19px]">
      <div className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[10px] text-left text-nowrap tracking-[-0.3px]">
...
function Frame1068() {
  return (
    <div className="bg-[rgba(217,217,217,0.3)] relative rounded-[3px] shrink-0 size-[19px]">
      <div className="box-border content-stretch flex flex-col gap-2.5 items-center justify-center overflow-clip px-1.5 py-[3.5px] relative size-[19px]">
        <div className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-[rgba(0,0,0,0.45)] text-left text-nowrap tracking-[-0.3px]">
          <p className="adjustLetterSpacing block leading-[normal] whitespace-pre">
            2
          </p>
        </div>
  ...
  return (
    <div className="bg-[rgba(217,217,217,0.3)] relative rounded-[3px] shrink-0 size-[19px]">
      <div className="flex flex-col items-center justify-center overflow-clip relative size-full">
        <div className="box-border content-stretch flex flex-col gap-2.5 items-center justify-center px-[11px] py-1.5 relative size-[19px]">
          <div className="flex flex-col font-['Inter:Medium',_sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[10px] text-[rgba(0,0,0,0.45)] text-left text-nowrap tracking-[-0.3px]">
            <p className="adjustLetterSpacing block leading-[normal] whitespace-pre">
              3
            </p>
...
function Frame144() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[60px] items-start justify-start left-[100px] p-0 top-[93px] w-[1100px]">
      <Frame145 />
      <Frame142 />
    </div>
  );
...
export default function Notice() {
  return (
    <div className="bg-[#ffffff] relative size-full" data-name="notice">
      <Header />
      <Footer />
      <Frame144 />
    </div>

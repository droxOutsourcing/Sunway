...
import { imgTeam } from "@/assets/images/placeholder";
  ...
  return (
    <div className="box-border content-stretch flex flex-row gap-[15px] items-center justify-start p-0 relative shrink-0 text-[#ffffff] text-nowrap">
      ...
      <div className="font-['Pretendard:Regular',_sans-serif] relative shrink-0 text-[18px]">
        <p className="block leading-[normal] text-nowrap whitespace-pre">{`Translation & Notarization`}</p>
      </div>
    </div>
  );
}
...
function SectionHeader() {
  return (
    <div
      className="bg-[#136bd0] relative rounded-[20px] shrink-0 w-full"
...
function Frame82() {
  return (
    <div className="bg-[#f6f5f5] box-border content-stretch flex flex-row gap-2.5 items-center justify-center px-[30px] py-2.5 relative rounded-[7px] shrink-0">
      <div className="absolute border border-[#cdcdcd] border-solid inset-0 pointer-events-none rounded-[7px]" />
      <div className="font-['Pretendard:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#000000] text-[21px] text-center text-nowrap">
...
function Frame84() {
  return (
    <div className="bg-[#ffffff] box-border content-stretch flex flex-row gap-2.5 items-center justify-center px-[30px] py-2.5 relative rounded-[7px] shrink-0">
      <div className="absolute border border-[#da1a1a] border-solid inset-0 pointer-events-none rounded-[7px]" />
      <div className="font-['Pretendard:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#000000] text-[21px] text-center text-nowrap">
        <p className="block leading-[normal] whitespace-pre">기타 인증서</p>
      </div>
    </div>
  );
}
...
function ServiceHeader() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col gap-[30px] items-start justify-start left-[100px] p-0 top-[93px] w-[1100px]"
      data-name="service header"
    >
      <SectionHeader />
      <Frame81 />
    </div>
...
function SectionHeader1() {
  return (
    <div
      className="box-border content-stretch flex flex-row gap-[15px] items-center justify-start pb-2.5 pt-0 px-0 relative shrink-0 w-full"
      data-name="section header"
    >
...
function Frame131() {
  return (
    <div className="bg-neutral-100 box-border content-stretch flex flex-row gap-2.5 items-start justify-start pb-[70px] pt-[35px] px-[52px] relative shrink-0 w-[1100px]">
      <div className="basis-0 font-['Pretendard:Medium',_sans-serif] grow leading-[0] min-h-px min-w-px not-italic relative shrink-0 text-[#000000] text-[18px] text-left tracking-[0.9px]">
        <p className="block leading-[28px]">
          소녀가 가만히 보조개를 떠올리며, 그래 이게 무슨 물 같니. 소년은 스웨터
          앞자락만 바라다보고 있었다. 그래 이게 무슨 물 같니. 소년은 스웨터
          앞자락만 바라다보고 있었다.
        </p>
      </div>
    </div>
...
function Frame130() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[30px] items-start justify-start p-0 relative shrink-0 w-[1100px]">
      <SectionHeader1 />
...
function Banner3() {
  return (
    <div
      className="h-[248px] relative shrink-0 w-[1100px]"
      data-name="banner 3"
    >
...
function ContentSection() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col gap-2.5 items-start justify-start left-[100px] p-0 top-[388px] w-[1100px]"
...
export default function Service02() {
  return (
    <div className="bg-[#ffffff] relative size-full" data-name="service02">
      <Header />
      <ServiceHeader />
      <ContentSection />
      <Footer />

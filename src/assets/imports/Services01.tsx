import svgPaths from "./svg-w4baxm3xvx";
import { imgTeam } from "@/assets/images/placeholder";
import { imgGroup, imgGroup1 } from "./svg-82bn8";
...
function Frame84() {
  return (
    <div className="bg-[#ffffff] box-border content-stretch flex flex-row gap-2.5 items-center justify-center px-[30px] py-2.5 relative rounded-[7px] shrink-0">
      ...
      <div className="font-['Pretendard:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#da1a1a] text-[21px] text-center text-nowrap">
...
function ContentSection() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col gap-2.5 items-start justify-start left-[100px] p-0 top-[448px] w-[1100px]"
...
export default function Services01() {
  return (
    <div className="bg-[#ffffff] relative size-full" data-name="services01">
      <Header />
      <ServiceHeader />
      <ContentSection />
      <Footer />

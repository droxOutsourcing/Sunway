...
import svgPaths from "@/assets/imports/svg-c4e73c007s";
import { imgFrame1021 } from "@/assets/images/placeholder";
import { imgGroup1 } from "@/assets/imports/svg-7e7lr";
import { NavigationProps } from "@/types";

interface NoticeDetailProps extends NavigationProps {
  noticeId?: number;
}
...
export default function NoticeDetail({ currentPage, onNavigate, noticeId = 1 }: NoticeDetailProps) {

...
import svgPaths from "@/assets/imports/svg-rm451kdufz";
import { imgTeam } from "@/assets/images/placeholder";
import { imgGroup, imgGroup1 } from "@/assets/imports/svg-empjj";
...
function ServiceTag({ 
  ...
  return (
    <div 
      className={`${isActive ? 'bg-[#ffffff] border-[#136bd0]' : 'bg-[#f6f5f5] border-[#cdcdcd] hover:bg-[#e6e5e5] transition-colors'} box-border content-stretch flex flex-row gap-2.5 items-center justify-center px-[30px] py-2.5 relative rounded-[7px] shrink-0 cursor-pointer`}
      onClick={onClick}
    >
      <div className="absolute border border-solid inset-0 pointer-events-none rounded-[7px]" />
      <div className={`font-['Pretendard:Regular',_sans-serif] leading-[0] not-italic relative shrink-0 ${isActive ? 'text-[#136bd0]' : 'text-[#000000]'} text-[21px] text-center text-nowrap`}>
...
function ServiceTagsSection({ activeService, setActiveService }: { 
    ...
    <div className="box-border content-stretch flex flex-col gap-[30px] items-start justify-start p-0 relative shrink-0 w-full">
      ...
      <div className="box-border content-stretch flex flex-col items-start justify-center p-0 relative shrink-0 w-full">
        ...
        <div className="bg-[#ffffff] relative shrink-0 w-full">
          <div className="absolute border-[#136bd0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
          <div className="flex flex-row items-center relative size-full">
            <div className="box-border content-stretch flex flex-row gap-2.5 items-center justify-start px-[50px] py-2.5 relative w-full">
              <div className="font-['Pretendard:SemiBold',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#136bd0] text-[26px] text-left text-nowrap tracking-[1.3px]">
        ...
        <div className="bg-neutral-100 basis-0 box-border content-stretch flex flex-row gap-2.5 grow items-start justify-start min-h-px min-w-px pb-[70px] pt-[35px] px-[52px] relative shrink-0 w-full">
          <div className="font-['Pretendard:Medium',_sans-serif] leading-[0] not-italic relative shrink-0 text-[#000000] text-[18px] text-left tracking-[0.9px] w-full">
            <p className="block leading-[28px]">
              소녀가 가만히 보조개를 떠올리며, 그래 이게 무슨 물 같니. 소년은 스웨터
              앞자락만 바라다보고 있었다. 그래 이게 무슨 물 같니. 소년은 스웨터
              앞자락만 바라다보고 있었다.
...
export default function Service02({ currentPage, onNavigate }: NavigationProps) {
  const [activeService, setActiveService] = useState("기타 인증서");

  return (
    <div className="bg-[#ffffff] min-h-screen flex flex-col w-full" data-name="service02">
      ...
      <div className="w-full max-w-[1100px] mx-auto px-[100px] py-[30px]">
        ...
        <div className="box-border content-stretch flex flex-col gap-[30px] items-start justify-start p-0 relative shrink-0 w-full mb-[50px]">
          <SectionHeader />
          <ServiceTagsSection activeService={activeService} setActiveService={setActiveService} />
        </div>
